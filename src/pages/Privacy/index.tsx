...
const Privacy = ({ t }: { t: any }) => {
  return (
    <Container>
      <PrivacyWrapper>
        <h1>{t("Privacy Policy")}</h1>
        
        <p>{t("This privacy policy applies to the Penguin Puzzle app (hereby referred to as \"Application\") for mobile devices that was created by Tran Thien Kien Thuc (hereby referred to as \"Service Provider\") as an Ad Supported service. This service is intended for use \"AS IS\".")}</p>
