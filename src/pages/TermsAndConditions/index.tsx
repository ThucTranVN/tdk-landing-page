...
const TermsAndConditions = ({ t }: { t: any }) => {
  return (
    <Container>
      <TermsWrapper>
        <h1>{t("Terms & Conditions")}</h1>
        
        <p>{t("These terms and conditions apply to the Penguin Puzzle app (hereby referred to as \"Application\") for mobile devices that was created by Tran Thien Kien Thuc (hereby referred to as \"Service Provider\") as an Ad Supported service.")}</p>
